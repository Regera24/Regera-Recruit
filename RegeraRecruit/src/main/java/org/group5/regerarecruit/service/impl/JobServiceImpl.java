...
public class JobServiceImpl implements JobService {
    ...
    public PageResponse<JobDTO> getAllJobsWithSortAndSearchByCriteria(
            int offset, int pageSize, String sort, String... searchs) {
        return searchRepository.getAllJobWithSortAndSearchByCriteria(offset, pageSize, sort, null, searchs);
    }
    ...
    public PageResponse<JobDTO> getAllJobsWithSortAndSearchByCriteriaAndCompany(
        ...
        return searchRepository.getAllJobWithSortAndSearchByCriteria(offset, pageSize, sort, companyId, searchs);
    }
